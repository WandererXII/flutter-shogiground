...
// void main() {
//   const board = StaticShogiboard(size: boardSize, orientation: Side.white, fen: kInitialFEN);

//   testWidgets('initial position display', (WidgetTester tester) async {
//     await tester.pumpWidget(board);

//     expect(find.byType(StaticShogiboard), findsOneWidget);
