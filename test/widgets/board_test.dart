...
// import 'package:shogiground/src/widgets/promotion.dart';
...
//     final viewOnlyBoard = Shogiboard.fixed(
//       size: boardSize,
//       orientation: Side.white,
//       fen: kInitialFEN,
//       settings: const ShogiboardSettings(drawShape: DrawShapeOptions(enable: true)),
...
//       expect(find.byType(Shogiboard), findsOneWidget);
...
//       const board = Shogiboard.fixed(size: boardSize, orientation: Side.white, fen: kInitialFEN);
...
//       final size = tester.getSize(find.byType(SolidColorShogiboardBackground));
...
//         orientation: Side.white,
//         fen: kInitialFEN,
//         settings: ShogiboardSettings(hue: 100.0),
//       );
...
//         orientation: Side.white,
//         fen: kInitialFEN,
//         settings: ShogiboardSettings(brightness: 0.9),
//       );
...
//         const ShogiboardSettings(border: BoardBorder(width: 16.0, color: Color(0xFF000000))),
//       ]) {
//         final onTouchedSquare = OnTappedSquareMock();
...
//       for (final settings in [
//         const ShogiboardSettings(pieceShiftMethod: PieceShiftMethod.drag),
//         const ShogiboardSettings(
...
//         const _TestApp(
//           initialPlayerSide: PlayerSide.both,
//           settings: ShogiboardSettings(pieceShiftMethod: PieceShiftMethod.drag),
//         ),
//       );
//       await tester.tap(find.byKey(const Key('e2-whitepawn')));
//       await tester.pump();
...
//         _TestApp(
//           initialPlayerSide: PlayerSide.both,
//           settings: const ShogiboardSettings(enableDropMoves: true),
//           bottomWidget: Column(
//             children: [
//               Draggable(
...
//                   size: squareSize,
//                   pieceAssets: PieceSet.ps1kanji3dStandardAssets,
//                 ),
//               ),
//               Draggable(
...
//       await tester.pumpWidget(
//         const _TestApp(
//           settings: ShogiboardSettings(autoQueenPromotion: true),
//           initialPlayerSide: PlayerSide.both,
//           initialFen: '8/5P2/2RK2P1/8/4k3/8/8/7r w - - 0 1',
//         ),
//       );
...
//       await tester.pumpWidget(
//         const _TestApp(
//           settings: ShogiboardSettings(animationDuration: Duration.zero),
//           initialPlayerSide: PlayerSide.white,
...
//                   .fen,
//           settings: const ShogiboardSettings(
//             animationDuration: Duration.zero,
...
//             settings: const ShogiboardSettings(animationDuration: Duration.zero),
//             initialPlayerSide: PlayerSide.both,
...
//     Shogiboard fixedBoard({ISet<Square>? explosionSquares}) => Shogiboard.fixed(
//       size: boardSize,
//       orientation: Side.white,
//       fen: kInitialFEN,
...
//   final orientation = tester.widget<Shogiboard>(find.byType(Shogiboard)).orientation;
...
//   final NormalMoveOrDrop? initialPromotionMove;
...
//   late NormalMoveOrDrop? promotionMove;
//   late ISet<Shape> shapes;
//   late Position position;
//   MoveOrDrop? lastMove;
//   MoveOrDrop? premoveData;

//   StreamSubscription<GameEvent>? _gameEventSub;

//   ShogiboardSettings get defaultSettings => ShogiboardSettings(
...
//               scheduleMicrotask(() {
//                 setState(() {
//                   promotionMove = premoveData as NormalMoveOrDrop?;
//                   premoveData = null;
//                 });
//               });
//             }
