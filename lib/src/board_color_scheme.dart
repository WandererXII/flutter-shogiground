...
/// Describes the color scheme of a [ShogiboardBackground].
///
/// Use the `static const` members to ensure flutter doesn't rebuild the board
/// background more than necessary.
@immutable
class ShogiboardColorScheme {
  const ShogiboardColorScheme({
  ...
  bool operator ==(Object other) {
    ...
    return other is ShogiboardColorScheme &&
  ...
  static const brown = ShogiboardColorScheme(
    lightSquare: Color(0xfff0d9b6),
    darkSquare: Color(0xffb58863),
    background: SolidColorShogiboardBackground(
      lightSquare: Color(0xfff0d9b6),
      darkSquare: Color(0xffb58863),
      shogiType: ShogiType.standard,
    ),
    whiteCoordBackground: SolidColorShogiboardBackground(
      lightSquare: Color(0xfff0d9b6),
      darkSquare: Color(0xffb58863),
      coordinates: true,
      shogiType: ShogiType.standard,
    ),
    blackCoordBackground: SolidColorShogiboardBackground(
      lightSquare: Color(0xfff0d9b6),
      darkSquare: Color(0xffb58863),
      coordinates: true,
      orientation: Side.gote,
      shogiType: ShogiType.standard,
    ),
...
//   static const blue = ShogiboardColorScheme(
...
//   static const green = ShogiboardColorScheme(
...
//   static const ic = ShogiboardColorScheme(
...
//   static const blue2 = ShogiboardColorScheme(
//     lightSquare: Color(0xff97b2c7),
//     darkSquare: Color(0xff546f82),
//     background: ImageShogiboardBackground(
//       lightSquare: Color(0xff97b2c7),
//       darkSquare: Color(0xff546f82),
//       image: AssetImage('$_boardsPath/blue2.jpg', package: 'chessground'),
//     ),
//     whiteCoordBackground: ImageShogiboardBackground(
//       lightSquare: Color(0xff97b2c7),
//       darkSquare: Color(0xff546f82),
//       image: AssetImage('$_boardsPath/blue2.jpg', package: 'chessground'),
//       coordinates: true,
//     ),
//     blackCoordBackground: ImageShogiboardBackground(
//       lightSquare: Color(0xff97b2c7),
//       darkSquare: Color(0xff546f82),
//       image: AssetImage('$_boardsPath/blue2.jpg', package: 'chessground'),
//       coordinates: true,
...
//   static const blue3 = ShogiboardColorScheme(
...
//   static const blueMarble = ShogiboardColorScheme(
...
//   static const canvas = ShogiboardColorScheme(
...
//   static const greenPlastic = ShogiboardColorScheme(
...
//   static const grey = ShogiboardColorScheme(
...
//   static const horsey = ShogiboardColorScheme(
...
//   static const leather = ShogiboardColorScheme(
...
//   static const maple = ShogiboardColorScheme(
...
//   static const maple2 = ShogiboardColorScheme(
...
//   static const marble = ShogiboardColorScheme(
...
//   static const metal = ShogiboardColorScheme(
...
//   static const newspaper = ShogiboardColorScheme(
...
//   static const olive = ShogiboardColorScheme(
...
//   static const pinkPyramid = ShogiboardColorScheme(
...
//   static const purple = ShogiboardColorScheme(
...
//   static const purpleDiag = ShogiboardColorScheme(
...
//   static const wood = ShogiboardColorScheme(
...
//   static const wood2 = ShogiboardColorScheme(
...
//   static const wood3 = ShogiboardColorScheme(
...
//   static const wood4 = ShogiboardColorScheme(
